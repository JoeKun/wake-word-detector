...
alignas(tflite::MicroMutableOpResolver<6>)
    static uint8_t resolver_buffer[sizeof(tflite::MicroMutableOpResolver<6>)];
static tflite::MicroMutableOpResolver<6>* resolver = nullptr;
...
tflite_status_t tflite_model_init(
    ...
    resolver = new (resolver_buffer) tflite::MicroMutableOpResolver<6>();
